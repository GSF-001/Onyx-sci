...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonVariants(), "transition-transform duration-150 active:scale-[0.98]", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "mt-2 transition-transform duration-150 active:scale-[0.98] sm:mt-0",
      className
    )}
    {...props}
  />
