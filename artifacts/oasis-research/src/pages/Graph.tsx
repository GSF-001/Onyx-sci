...
function layoutGraph(
  ...
  const center = nodes.reduce(
    (best, n) => (!best || n.weight > best.weight ? n : best),
    nodes[0],
  );
...
export default function GraphPage() {
  ...
  const graph = exploreMutation.data
    ? layoutGraph(
        exploreMutation.data.nodes ?? [],
        exploreMutation.data.edges ?? [],
      )
    : null;
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-neutral-200 z-10 flex-shrink-0">
          <div>
            ...
            <p className="text-xs text-neutral-500 mt-0.5">
              Visualisasikan hubungan antar konsep, metode, dan peneliti
            </p>
          </div>
          <form onSubmit={handleExplore} className="flex gap-2 w-[380px]">
            ...
            <Button
              ...
              className="rounded-xl bg-neutral-900 hover:bg-neutral-800 text-sm px-5"
            >
          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            <div className="absolute top-4 right-4 z-10 flex flex-col gap-1">
              <button
                ...
                className="w-8 h-8 bg-white border border-neutral-200 rounded-lg flex items-center justify-center hover:bg-neutral-50 shadow-sm"
              >
            ...
            {!exploreMutation.data && !exploreMutation.isPending && (
              <div className="absolute inset-0 flex flex-col items-center justify-center text-neutral-400">
                ...
                <p className="text-base font-medium mb-1">
                  Pilih konsep untuk dijelajahi
                </p>
                <p className="text-sm">
                  Ketik konsep di atas atau pilih dari daftar cepat
                </p>
              </div>
            )}
                    ...
                    return (
                      ...
                      >
                        ...
                        <text
                          ...
                          fontSize={Math.max(
                            9,
                            12 - Math.max(0, node.label.length - 8),
                          )}
                          fontWeight="600"
                          fill={c.text}
                        >
              ...
              {exploreMutation.data?.insights && (
                <div className="p-4 border-b border-neutral-100">
                  <div className="flex items-start gap-2 mb-2">
                    ...
                    <p className="text-[11px] font-semibold text-neutral-500 uppercase tracking-wider mt-1">
                      Wawasan AI
                    </p>
                  </div>
                ...
                <div className="p-4 border-b border-neutral-100 bg-blue-50/50">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <div
                      ...
                      style={{
                        backgroundColor: (
                          TYPE_COLOR[selected.type] ?? TYPE_COLOR.default
                        ).fill,
                        borderColor: (
                          TYPE_COLOR[selected.type] ?? TYPE_COLOR.default
                        ).stroke,
                  ...
                  <span
                    ...
                    style={{
                      color: (TYPE_COLOR[selected.type] ?? TYPE_COLOR.default)
                        .text,
                      borderColor: (
                        TYPE_COLOR[selected.type] ?? TYPE_COLOR.default
                      ).stroke,
                  ...
                  {graph?.nodePosArr.map((node) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="text-[10px] text-neutral-400 line-clamp-1 ml-4">
                          {node.description}
                        </p>
                      </button>
                    );
